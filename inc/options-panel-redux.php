<?php
    ...
    // Here we created name for our settings
    $opt_name = "tree_theme_options";
    ...
    Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'Global Settings', 'tree_theme' ),
        'id'               => 'globalsettings',
        'desc'             => esc_html__( 'Options for header and footer', 'tree_theme' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-cogs'
    ) );

    Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'Social profiles', 'tree_theme' ),
        'id'               => 'social_profiles',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => esc_html__( 'Add links profiles for Social', 'tree_theme' ),
        'fields'           => array(
            array(
                'id'       => 'social_links',
                'type'     => 'sortable',
                'title'    => esc_html__( 'Social links', 'tree_theme' ),
                'subtitle' => esc_html__( 'Insert links for your social profiles', 'tree_theme' ),
                'desc'     => esc_html__( 'Let the field empty if you do not have a link', 'tree_theme' ),
                'label'    => true,
                'options'  => array(
                    'Vk link'   => '',
                    'Facebook link'   => '',
    ...
    Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'Contact Data', 'tree_theme' ),
        'id'               => 'contacts',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => esc_html__( 'Add contacts data for header and footer', 'tree_theme' ),
        'fields'           => array(
            array(
                'id'       => 'Header-start',
                'type'     => 'section',
                'title'    => esc_html__( 'Header Data', 'tree_theme' ),
                'indent'   => true, // Indent all options below until the next 'section' option is set.
            ),
            array(
                'id'       => 'header_phone_label',
                'type'     => 'text',
                'title'    => esc_html__( 'Header Phone label', 'tree_theme' ),
                'subtitle' => esc_html__( 'Insert Phone label', 'tree_theme' ),
            ...
            array(
                'id'       => 'header_phone',
                'type'     => 'text',
                'title'    => esc_html__( 'Header Phone', 'tree_theme' ),
                'subtitle' => esc_html__( 'Insert Phone', 'tree_theme' ),
            ),
            array(
                'id'     => 'header-end',
                'type'   => 'section',
            ...
            array(
                'id'       => 'footer-start',
                'type'     => 'section',
                'title'    => esc_html__( 'Footer Data', 'tree_theme' ),
                'indent'   => true, // Indent all options below until the next 'section' option is set.
            ),
            array(
                'id'       => 'footer_address',
                'type'     => 'text',
                'title'    => esc_html__( 'Your address', 'tree_theme' ),
                'default'  => '',
            ),
            array(
                'id'       => 'footer_phone',
                'type'     => 'multi_text',
                'title'    => esc_html__( 'Contacts phone', 'tree_theme' ),
                'subtitle' => esc_html__( 'Add your Phones', 'tree_theme' ),
                'desc'     => esc_html__( 'Add or remove items', 'tree_theme' ),
            ),
            array(
                'id'       => 'footer_email',
                'type'     => 'text',
                'title'    => esc_html__( 'Email', 'tree_theme' ),
                'validate' => 'email',
            ...
            array(
                'id'       => 'footer_info',
                'type'     => 'text',
                'title'    => esc_html__( 'Footer info', 'tree_theme' ),
                'subtitle' => esc_html__( 'Info after sosial icons', 'tree_theme' ),
                'default'  => '',
            ),
            array(
                'id'      => 'footer_copyrights',
                'type'    => 'editor',
                'title'   => esc_html__( 'Copyrights', 'tree_theme' ),
                'default' => '©2007-2020 Все права защищены.',
                'args'    => array(
                    'wpautop'       => false,
                    'media_buttons' => false,
                    'textarea_rows' => 5,
            ...
            array(
                ...
                'type'     => 'section',
                'title'    => esc_html__( 'Footer section Headers', 'tree_theme' ),
                'indent'   => true, // Indent all options below until the next 'section' option is set.
            ),
            array(
                'id'       => 'footer_section1',
                'type'     => 'text',
                'title'    => esc_html__( 'First Section Title', 'tree_theme' ),
                'default'  => 'Карта сайта',
            ),
            array(
                'id'       => 'footer_section2',
                'type'     => 'text',
                'title'    => esc_html__( 'Second Section Title', 'tree_theme' ),
                'default'  => 'Услуги',
            ),
            array(
                'id'       => 'footer_section3',
                'type'     => 'text',
                'title'    => esc_html__( 'Third Section Title', 'tree_theme' ),
                'default'  => 'Контакты',
            ),
            array(
                'id'       => 'footer_section4',
                'type'     => 'text',
                'title'    => esc_html__( 'Fourth Section Title', 'tree_theme' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'Home Header', 'tree_theme' ),
        'id'               => 'home_header',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => esc_html__( 'Add Media files and data for Home Header', 'tree_theme' ),
        'fields'           => array(
            array(
                'id'       => 'header_bg',
                'type'     => 'media',
                'url'      => true,
                'title'    => esc_html__( 'Background for Home Header', 'tree_theme' ),
                'compiler' => 'true',
                'desc'     => esc_html__( 'Recommended size 1920px - 988px', 'tree_theme' ),
                'default'  => array( 'url' =>get_template_directory_uri(). '/assets/img/bg.jpg' ),
            ),
            array(
                'id'       => 'header_time',
                'type'     => 'text',
                'title'    => esc_html__( 'Specify the time', 'tree_theme' ),
                'default'  => '',
            ),
            array(
                'id'        => 'header_video',
                'type'      => 'text',
                'title'     => esc_html__( 'Specify the video link', 'tree_theme' ),
                'desc'      => __( 'Field Description', 'redux-framework-demo' ),
                'default'   => '',
                'text_hint' => array(
                    'title'   => 'Link for YouTybe',
                    'content' => 'Use a simple link from the browser bar to a YouTube video'
                )
            ),
            array(
                'id'       => 'header_video_title',
                'type'     => 'text',
                'title'    => esc_html__( 'Specify the video title', 'tree_theme' ),
                'default'  => '',
            ),
            array(
    ...
    Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'Post Types', 'tree_theme' ),
        'id'               => 'postype',
        'desc'             => esc_html__( 'Options for custom Post Types', 'tree_theme' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-home'
    ) );
    Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'Testimonials', 'tree_theme' ),
        'id'               => 'testimonials_posttype',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => esc_html__( 'Data for Testimonials Page', 'tree_theme' ),
        'fields'           => array(
            array(
                'id'       => 'testimonial_label1',
                'type'     => 'text',
                'title'    => esc_html__( 'Specify the label', 'tree_theme' ),
                'default'  => 'За нас говорят',
            ),
            array(
                'id'        => 'testimonial_label2',
                'type'      => 'text',
                'title'     => esc_html__( 'Specify the label', 'tree_theme' ),
                'default'   => 'Наши клиенты',
            ),
	        array(
		        'id'       => 'testimonial-posts-start',
		        'type'     => 'section',
		        'title'    => esc_html__( 'Testimonial posts section ', 'tree_theme' ),
		        'indent'   => true, // Indent all options below until the next 'section' option is set.
	        ),
            array(
                'id'        => 'testimonial_posts',
                'type'      => 'text',
                'title'     => esc_html__( 'Specify the count of testimonial per page', 'tree_theme' ),
                'default'   => '6',
            ),
	        array(
		        'id'     => 'testimonial-posts-end',
		        'type'   => 'section',
		        'indent' => false, // Indent all options below until the next 'section' option is set.
	        ),
	        array(
		        'id'       => 'testimonial-form-start',
		        'type'     => 'section',
		        'title'    => esc_html__( 'Testimonial form section ', 'tree_theme' ),
		        'indent'   => true, // Indent all options below until the next 'section' option is set.
	        ),
	        array(
		        'id'        => 'testimonial_form_shortcode',
		        'type'      => 'text',
		        'title'     => esc_html__( 'Form Shortcode', 'tree_theme' ),
		        'desc'      => esc_html__( 'Install plugin and type shortcode form in this field', 'tree_theme' ),
		        'default'   => '',
	        ),
	        array(
		        'id'     => 'testimonial-form-end',
		        'type'   => 'section',
		        'indent' => false, // Indent all options below until the next 'section' option is set.
	        ),
        )
	...
	Redux::setSection( $opt_name, array(
		'title'            => esc_html__( 'Services', 'tree_theme' ),
		'id'               => 'services_posttype',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Data for Services Page', 'tree_theme' ),
		'fields'           => array(
			array(
				'id'        => 'service_currency',
				'type'      => 'text',
