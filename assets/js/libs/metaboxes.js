...
jQuery(document).ready(function ($) {
	...
	$('.ale_upload_button').live('click', function () {
		var buttonLabel;
		formfield = $(this).prev('input').attr('name');
		buttonLabel = 'Use as ' + $('label[for=' + formfield + ']').text();
		tb_show('', 'media-upload.php?post_id=' + $('#post_ID').val() + '&type=file&ale_force_send=true&ale_send_label=' + buttonLabel + '&TB_iframe=true');
		return false;
	});

	$('.ale_remove_file_button').live('click', function () {
